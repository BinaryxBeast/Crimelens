-- Enable PostGIS (optional but useful for geo queries)
...
-- ============================================================
-- TABLE: CaseMasterAccused (junction)
-- (derived from Relationship_Matrix: CaseMaster → Accused)
-- ============================================================
CREATE TABLE IF NOT EXISTS "CaseMasterAccused" (
  "CaseMasterID" uuid REFERENCES "CaseMaster"("CaseMasterID") ON DELETE CASCADE,
  "AccusedMasterID" uuid REFERENCES "Accused"("AccusedMasterID") ON DELETE CASCADE,
  role        text DEFAULT 'Primary',
  PRIMARY KEY ("CaseMasterID", "AccusedMasterID")
);

-- ============================================================
-- Row Level Security (enable after seeding if needed)
-- ============================================================
...
-- Indexes
-- ============================================================
CREATE INDEX IF NOT EXISTS idx_CaseMaster_district    ON "CaseMaster"("DistrictID");
CREATE INDEX IF NOT EXISTS idx_CaseMaster_crime_type  ON "CaseMaster"("CrimeMajorHeadID");
CREATE INDEX IF NOT EXISTS idx_CaseMaster_occurred_at ON "CaseMaster"("IncidentFromDate");
CREATE INDEX IF NOT EXISTS idx_CaseMaster_severity    ON "CaseMaster"("GravityOffenceID");
